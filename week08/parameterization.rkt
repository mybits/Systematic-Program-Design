...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))

(define (area r)
  (* pi (sqr r)))

(area 4) ;(* pi (sqr 4)) ;area of circle diameter 4
(area 6) ;(* pi (sqr 6)) ;area of circle diameter 6
